...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		//Escribe el código para verificar el tipo de tecla que se presion
		aplhabetkey();
		document.getElementById("d1").innerHTML="Tu presionaste una tecla de letra"}
	else {
		otherkey();
		document.getElementById("d1").innerHTML="tu presionaste otro simbolo"
